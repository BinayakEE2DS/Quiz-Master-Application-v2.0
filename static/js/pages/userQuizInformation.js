const UserQuizInformation = {
      ...
      <div>
        ...
        <div id="quiz-info-container">
          ...
          <div class="buttons" style="text-align: center">
            <br>
            <router-link to="/user" class="btn btn-danger">Close</router-link>
          </div>
        </div>
      </div>
    `,
    ...
    mounted() {
      const quizId = this.$route.params.quizId; // Get quizId from the route
      this.fetchQuizInfo(quizId); // Fetch quiz information
    }
  };
  
  // Add scoped styles
  UserQuizInformation.style = `
    <style scoped>
      #quiz-info-container {
  ...
  export default UserQuizInformation;